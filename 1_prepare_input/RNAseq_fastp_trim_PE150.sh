...
#SBATCH --time=1:00:00 
#SBATCH --output=/gpfs/khrameeva/Data/Halisarca_RNA/filter_pe150.log
#SBATCH --error=/gpfs/khrameeva/Data/Halisarca_RNA/filter_pe150.err
source ~/software/miniconda3/bin/activate ~/software/bio_basics

INDIR=/gpfs/khrameeva/Data/Halisarca_RNA/raw_for_annotation/
OUTDIR=/gpfs/khrameeva/Data/Halisarca_RNA/trimmed_for_annotation/SPB_regen/
