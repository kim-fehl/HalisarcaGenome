...
INDIR=/gpfs/khrameeva/Halisarca_analysis/2025_11_14_annotation/Validation/Test_SkHd3/
INDEX=/gpfs/khrameeva/Halisarca_analysis/2025_11_14_annotation/Validation/index/SkHd3/len_151/
...
file=`ls ${INDIR} | grep fastq | cut -f1,2,3,4,5,6,7 -d '_' |sort |uniq| head -n $SLURM_ARRAY_TASK_ID | tail -n 1`
