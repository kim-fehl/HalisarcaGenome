...
#SBATCH --output=/gpfs/khrameeva/Halisarca_analysis/2025_11_08_hic_scaffolding/3d-dna/batch1_lowcoarseres/3d-dna.log
#SBATCH --error=/gpfs/khrameeva/Halisarca_analysis/2025_11_08_hic_scaffolding/3d-dna/batch1_lowcoarseres/3d-dna.err
...
bash run-asm-pipeline.sh \
	...
	/gpfs/khrameeva/Halisarca_analysis/2025_11_08_hic_scaffolding/juicer_batch1/aligned/merged_nodups.txt
